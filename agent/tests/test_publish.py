...
def test_publish_signs_correctly() -> None:
    ...
    Validates: Schnorr signature against the offering agent's pubkey,
...
def test_publish_no_image_tag_ever() -> None:
    ...
    the single most important invariant of the offering agent plugin and
