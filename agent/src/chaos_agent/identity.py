"""Publisher-side Nostr identity: keypair load/save + Schnorr signing.

The keypair lives at ``~/.chaos/keys/agent.key`` mode 0600.
...
DEFAULT_KEY_PATH = KEYS_DIR / "agent.key"


@dataclass(frozen=True, slots=True)
class Identity:
    """Holds an immutable view of the offering agent's secp256k1 keypair.
